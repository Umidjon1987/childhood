        ...
        <div class="reply">
            <div class="reply__body">
                <div class="reply__title">
                    ...
                    <?php echo do_shortcode('[contact-form-7 id="161" title="Форма вопросов"]'); ?>
            </div>
        </div>
        <footer>
            <div class="container">
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    <a href="tel:<?php the_field('phone_basic')?>"><?php the_field('phone_basic')?></a>
                                    <a href="tel:<?php the_field('phone_additional')?>"><?php the_field('phone_additional')?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDosYptwVwX6Ld_Yv-MlCRruzvYFXLtM1g"></script> // Ваш ключ Google API 
