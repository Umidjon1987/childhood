...
?>
        ...
        <div class="toys" id="toys">
            <div class="container">
                <h2 class="subtitle"><?php echo get_category_by_slug('soft_toys')->description; ?></h2>
                ...
                <h2 class="subtitle"><?php echo get_category_by_slug('edu_toys')->description; ?></h2>
                <div class="toys__wrapper">
                    <?php  
                        $my_posts = get_posts(array(
                            'numberposts' => -1,
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="contacts__map">
                            <?php echo do_shortcode('[yamap center="55.7382,37.5072" height="100%" controls="" zoom="12" type="yandex#map"][/yamap]'); ?> 
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="title contacts__minititle">Оставьте ваш отзыв</div>
                          <div class="contacts__feed">
                              <?php echo do_shortcode('[contact-form-7 id="160" title="Форма отзывов"]'); ?>
                          </div>
                    </div>
                </div>
                <div class="row mt70">
